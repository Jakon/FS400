...
// custom setup info
#define MyAppName 'SimWinO'
#define MyAppSetupName 'SimWinO'
#define MyAppVersion '0.1.0'
#define MyAppPublisher 'Make Touffe Great Again'
#define MyAppCopyright 'Copyright � Make Touffe Great Again'
#define MyAppURL ''
#define MyAppExeName 'SimWinO.WPF.exe'

[Setup]
AppId={{E9ADAFBF-AF86-4B8D-8E78-B23F30A03C9C}
...
OutputBaseFilename={#MyAppSetupName}_setup
